...
// Pra onde cada perfil vai depois do login / quando cai numa tela que não é
// dela. Central aqui pra loginAction e os guards de página nunca divergirem.
export function homeFor(role) {
  if (role === 'admin') return '/dashboard';
  if (role === 'pilotista') return '/pilotagem';
  return '/lancar';
}
